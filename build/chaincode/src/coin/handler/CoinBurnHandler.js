...
exports.CoinBurnHandler = void 0;
...
let CoinBurnHandler = class CoinBurnHandler extends handler_1.TransportCommandFabricAsyncHandler {
    service;
    constructor(logger, transport, service) {
        super(logger, transport, coin_1.CoinBurnCommand.NAME);
    ...
    async execute(params, holder) {
        ...
        await holder.stub.dispatch(new coin_2.CoinBurnedEvent(holder.eventData));
    }
};
__decorate([
    (0, guard_1.UserGuard)(),
