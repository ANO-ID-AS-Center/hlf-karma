...
exports.CompanyEditHandler = void 0;
...
let CompanyEditHandler = class CompanyEditHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, company_2.CompanyEditCommand.NAME);
    }
    async execute(params, holder) {
        ...
        await holder.stub.dispatch(new company_1.CompanyEditedEvent(holder.eventData));
    }
};
__decorate([
    (0, guard_1.UserGuard)(),
...
], CompanyEditHandler.prototype, "execute", null);
CompanyEditHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], CompanyEditHandler);
exports.CompanyEditHandler = CompanyEditHandler;
