...
exports.CompanyProjectListHandler = void 0;
...
let CompanyProjectListHandler = class CompanyProjectListHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, company_1.CompanyProjectListCommand.NAME);
    }
...
], CompanyProjectListHandler.prototype, "execute", null);
CompanyProjectListHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], CompanyProjectListHandler);
exports.CompanyProjectListHandler = CompanyProjectListHandler;
