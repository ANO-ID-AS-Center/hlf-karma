...
exports.CompanyUserRoleListHandler = void 0;
...
let CompanyUserRoleListHandler = class CompanyUserRoleListHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, company_1.CompanyUserRoleListCommand.NAME);
    }
...
], CompanyUserRoleListHandler.prototype, "execute", null);
CompanyUserRoleListHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], CompanyUserRoleListHandler);
exports.CompanyUserRoleListHandler = CompanyUserRoleListHandler;
