...
exports.ProjectUserListHandler = void 0;
...
let ProjectUserListHandler = class ProjectUserListHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, project_1.ProjectUserListCommand.NAME);
    }
...
], ProjectUserListHandler.prototype, "execute", null);
ProjectUserListHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], ProjectUserListHandler);
exports.ProjectUserListHandler = ProjectUserListHandler;
