...
let UserGetHandler = class UserGetHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, user_1.UserGetCommand.NAME);
    }
...
], UserGetHandler.prototype, "execute", null);
UserGetHandler = __decorate([
