...
exports.CompanyListHandler = void 0;
...
let CompanyListHandler = class CompanyListHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, company_1.CompanyListCommand.NAME);
    }
...
], CompanyListHandler.prototype, "execute", null);
CompanyListHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], CompanyListHandler);
exports.CompanyListHandler = CompanyListHandler;
