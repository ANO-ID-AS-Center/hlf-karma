...
exports.UserCompanyListHandler = void 0;
...
let UserCompanyListHandler = class UserCompanyListHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, user_1.UserCompanyListCommand.NAME);
    }
...
], UserCompanyListHandler.prototype, "execute", null);
UserCompanyListHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], UserCompanyListHandler);
exports.UserCompanyListHandler = UserCompanyListHandler;
