...
exports.UserListHandler = void 0;
...
let UserListHandler = class UserListHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, user_1.UserListCommand.NAME);
    }
...
], UserListHandler.prototype, "execute", null);
UserListHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], UserListHandler);
exports.UserListHandler = UserListHandler;
