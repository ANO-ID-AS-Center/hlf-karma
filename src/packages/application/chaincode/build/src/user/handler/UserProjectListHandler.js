...
exports.UserProjectListHandler = void 0;
...
let UserProjectListHandler = class UserProjectListHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, user_1.UserProjectListCommand.NAME);
    }
...
], UserProjectListHandler.prototype, "execute", null);
UserProjectListHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], UserProjectListHandler);
exports.UserProjectListHandler = UserProjectListHandler;
