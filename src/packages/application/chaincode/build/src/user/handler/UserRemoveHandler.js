...
exports.UserRemoveHandler = void 0;
...
let UserRemoveHandler = class UserRemoveHandler extends handler_1.TransportCommandFabricAsyncHandler {
    constructor(logger, transport) {
        super(logger, transport, user_1.UserRemoveCommand.NAME);
    }
    async execute(params, holder) {
        ...
        throw new error_1.LedgerError(error_1.LedgerErrorCode.BAD_REQUEST, `Unable to remove user: it's deprecated now`);
        await holder.db.user.remove(params.uid);
        await holder.stub.dispatch(new user_2.UserRemovedEvent(holder.eventData));
    }
};
__decorate([
    (0, guard_1.UserGuard)(),
...
], UserRemoveHandler.prototype, "execute", null);
UserRemoveHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.Logger, chaincode_1.TransportFabricChaincodeReceiver])
], UserRemoveHandler);
exports.UserRemoveHandler = UserRemoveHandler;
