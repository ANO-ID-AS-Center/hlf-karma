...
export * from './company-user-add/company-user-add.component';
export * from './company-user-role-edit/company-user-role-edit.component';
export * from './company-nalog-preferences/company-nalog-preferences.component';